                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <!-- Blog post-->
                            <div class="card mb-4">
                            	<a href="detail?idx=${vo.look_idx}&page=1"></a>
                                <a href="#!"><img class="card-img-top" src="${pageContext.request.contextPath}/image/${vo.look_filename}"/></a>
                                <div class="card-body">
                                    <div class="small text-muted">${vo.user_email}</div>
                                    <h2 class="card-title h4">Post Title</h2>
                                    <p class="card-text">${vo.look_content}</p>
                                    <a class="btn btn-primary btn-sm" href="#!"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
